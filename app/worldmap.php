	  ...
	  echo "<br><br><br>";
		...
		echo "<div class=\"container-fluid\">";
          ...
          echo "<div class=\"row img-responsive placeholders container-fluid col-xs-12 col-sm-9 col-md-8 col-sm-offset-1\">";
            echo "<iframe src=\"http://localhost:5601/app/kibana#/dashboard/dash5?embed=true&_g=(refreshInterval:(display:Off,pause:!f,value:0),time:(from:now%2FM,mode:quick,to:now%2FM))&_a=(filters:!(),options:(darkTheme:!f),panels:!((col:1,id:World-Map,panelIndex:1,row:1,size_x:7,size_y:7,type:visualization),(col:8,id:Project-About,panelIndex:2,row:1,size_x:3,size_y:2,type:visualization),(col:8,id:Secure-Headers-Use,panelIndex:3,row:3,size_x:5,size_y:5,type:visualization),(col:11,id:Sites-Analyzed,panelIndex:4,row:1,size_x:2,size_y:2,type:visualization)),query:(query_string:(analyze_wildcard:!t,query:'*')),title:dash5,uiState:(P-1:(spy:(mode:(fill:!f,name:!n))),P-3:(vis:(legendOpen:!f))))\" height=\"785\" width=\"1630\"></iframe>";
					echo "</div>";
